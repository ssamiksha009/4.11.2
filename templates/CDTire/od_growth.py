...
if len(sys.argv) > 1:
    ...
    if odb_files:
        ...
        print(f"[WARN] No ODB file specified, using: {odb_name}")
    else:
        print("[ERROR] No .odb files found in current directory")
        print("Usage: abaqus python od_growth.py <odb_file>.odb")
        sys.exit(1)
